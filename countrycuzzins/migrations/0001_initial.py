# Generated by Django 3.0.7 on 2020-09-24 06:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(max_length=120, storage=core.utils.utils_models.OverwriteStorage(), upload_to=countrycuzzins.models.makeSongName, verbose_name='song file')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('producer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='countrycuzzins.Producer', verbose_name='video producer')),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('image', models.ForeignKey(blank=True, default='images/default_album.png', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='album_image', to='countrycuzzins.Image')),
