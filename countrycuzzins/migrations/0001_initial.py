    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('producer', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, related_name='video_producer', to='countrycuzzins.Producer', verbose_name='video producer')),
                ('rating', models.ManyToManyField(related_name='video_ratings', to='core.Rating')),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('image', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='album_image', to='countrycuzzins.Image')),
                ('songs', models.ManyToManyField(related_name='alum_songs', to='countrycuzzins.Song')),
            ],
        ),
        migrations.CreateModel(
            name='Artist',
