...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('countrycuzzins', '0062_remove_album_image'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='album',
            name='image',
            field=models.ForeignKey(default=django.utils.timezone.now, on_delete=django.db.models.deletion.DO_NOTHING, related_name='album_image', to='countrycuzzins.Image'),
